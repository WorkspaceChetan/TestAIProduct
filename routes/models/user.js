...
const UserSchema = new Schema({
  ...
  referralId: { type: String, unique: true, maxLength: 100, default: v4() },
  referrerPaid: { type: Boolean, default: false }, // has the referral been given credits yet?
  referrer: { type: ObjectId, ref: "user" },
  is_subscribed: { type: Boolean, default: false },
  experience: { type: String, default: "", maxLength: 1500 },
  reviews: { type: String, default: "", maxLength: 500 },
  remaining_free_credits: { type: Number, default: 10 },
  remaining_paid_credits_this_month: { type: Number, default: 0 },
