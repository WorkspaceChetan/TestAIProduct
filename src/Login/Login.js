...
class Login extends Component {
  ...
  @observable infoMsg = false;
  @observable initialLoading = false;
  @observable initialError = "";
              ...
              <Switch>
                <Route path="/login">
                  <Logon
                    ...
                    handleErrorAny={this.handleErrorAny}
                  />
                </Route>
                <Route path="/signup">
                  <Signup
...
const Logon = observer(
  ({
    ...
    useEffect(() => {
        ...
        if (user) {
          ...
          if (isSignInWithEmailLink(auth, window.location.href)) {
            ...
            if (data.success) {
              ...
              handleErrorAny("Email verified successfully!", "info");
              history.push("/");
            }
          } else {
      ...
      verifyEmail();
    }, [user, search, history, handleErrorAny]);
